...
class CommonCause3DelayScenario(Scenario):
    ...
    def __init__(self, use_physics: bool = True):
        super().__init__(use_physics=use_physics)
        ...
        for lock in self.fsmm.observable_fsm.vars:
            if lock == "l1:" or lock == "l2:":
                ...
                super().add_no_ops(lock, pushed, pulled)
            else:
                pulled = [
                    s
                    for s in self.fsmm.observable_fsm.state_permutations
        ...
        super().add_nothing_transition()

        super().add_door_transitions()
    ...
    def update_state_machine(self, action: Optional[str] = None) -> None:
        ...
        """
        super().update_state_machine(action)
    ...
    def init_scenario_env(
        ...
        super().init_scenario_env(world_def, effect_probabilities)
